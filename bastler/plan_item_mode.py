...
Usage:
    python3 -m bastler.plan_item_mode resolve --skill <kickoff|resolve> [--requested <mode>]
    python3 -m bastler.plan_item_mode set --skill <kickoff|resolve> [--skill ...] --mode <mode>
