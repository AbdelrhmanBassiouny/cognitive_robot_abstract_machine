...
Usage:
    python3 -m bastler.missing_requirements <requirements-file>
...
def main() -> int:
    ...
    parser.add_argument(
        "requirements_file",
        type=Path,
        help="The requirements file to report the missing distributions of",
    )
    arguments = parser.parse_args()
    print(" ".join(RequirementsFile(arguments.requirements_file).missing()))
    return 0
