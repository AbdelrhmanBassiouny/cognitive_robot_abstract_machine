...
def test_a_build_asked_for_a_suite_it_has_no_command_for_is_refused():
    ...
    with pytest.raises(basstler.integration_suite.TestCommandNotConfiguredError):
        basstler.integration_build_commands.BuildCommand()._test_command(
...
def test_a_build_that_was_told_not_to_test_needs_no_command():
    ...
    assert basstler.integration_build_commands.BuildCommand()._test_command(
