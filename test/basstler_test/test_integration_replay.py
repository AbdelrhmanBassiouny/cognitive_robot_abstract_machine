...
import basstler.integration_run
from basstler.integration_constants import ReportKey
from basstler.integration_tips import ResolutionAuthor, ResolutionProvenance, TipStatus
...
def a_run(checkout: ForkCheckout) -> basstler.integration_run.IntegrationRun:
    """
    :param checkout: The checkout to run in.
    :return: A run wired to the scratch fork, without asking GitHub anything.
    """
    return basstler.integration_run.IntegrationRun(
