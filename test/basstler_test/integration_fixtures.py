...
from basstler.git_commands import BranchPublication, ProposedPush, ReferenceUpdate
from basstler.stack import Branch, BranchStatus, IntegrationStrategy, PullRequest, Stack

from basstler.integration_carried_pipeline import PIPELINE_PATHS
from basstler.integration_verdict import ChecksVerdict
from basstler.workflow_document import REPOSITORY_ROOT
import basstler.integration_constants
import basstler.integration_tips
import basstler.integration
from basstler.integration_assembly import build_integration
from basstler.integration_block_record import BlockStanding, MeasuredHead
from basstler.integration_failure import IntegrationTestFailure
from basstler.integration_report import IntegrationReport
from basstler.integration_run import IntegrationRun
from basstler.integration_tips import (
...
INTEGRATION_SCRIPT = Path(basstler.integration.__file__)
"""
...
def create_blocked_branch(
    ...
    return PullRequestStackTipOutcome(
        ...
        status=basstler.integration_tips.TipStatus.BLOCKED,
...
def a_recorded_resolution(checkout: ForkCheckout) -> None:
    ...
    """
    for setting in basstler.integration_constants.RERERE_SETTINGS:
...
def create_red_branch(
    ...
    return PullRequestStackTipOutcome(
        branch=branch,
        pull_request_number=0,
        status=basstler.integration_tips.TipStatus.CHECKS_FAILED,
