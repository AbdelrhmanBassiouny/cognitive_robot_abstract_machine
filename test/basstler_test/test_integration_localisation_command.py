...
from basstler.integration_localisation import Localisation, LocalisationStage
...
def test_a_concluded_search_blocks_the_branch_in_the_same_words_a_local_one_does(
    ...
    assert fork.comments[0].body.startswith(basstler.integration_failure.FAILURE_COMMENT_PREFIX)
