...
import basstler.integration_failure
...
from basstler.integration_block_record import BlockRecord, BlockRecords, MeasuredHead
from basstler.integration_failure import FailureLocationReport, IntegrationTestFailure
from basstler.integration_reproduction import REPRODUCTION_MARKER
...
def locate_break(
...
) -> basstler.integration.BreakLocationReport:
    """
    ...
    """
    return basstler.integration_failure.FailureLocation(
