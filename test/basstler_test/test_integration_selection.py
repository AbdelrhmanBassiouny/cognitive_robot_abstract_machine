...
from basstler.git_commands import ReferenceUpdate

import pytest

from basstler.stack import BranchStatus, Configuration, PullRequest, Stack
from basstler.integration_pass_record import PassRecord, RecordedSubject
from basstler.integration_verdict import ChecksVerdict

import basstler.integration_selection
from basstler.integration_constants import POINTER_BRANCH
from basstler.integration_exit_codes import IntegrationExitCode
from basstler.integration_report import exit_code_for
from basstler.integration_selection import (
    select_for_build,
    stack_to_build,
    tips_of,
)
from basstler.integration_tips import PullRequestStackTipOutcome, TipStatus
from basstler.integration_block_record import BlockRecord, BlockStanding
...
def test_a_build_that_restacks_is_made_from_the_stack_the_restack_left_behind(
    ...
    monkeypatch.setattr(basstler.integration_selection, "restack", lambda *arguments: None)
