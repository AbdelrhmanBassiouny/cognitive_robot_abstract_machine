...
from basstler.stack import BranchStatus, Stack
...
from basstler.integration_selection import select_for_build, stack_to_build, tips_of
from basstler.integration_tips import TipStatus
...
def test_a_restacked_branch_s_checks_are_read_after_the_restack_moved_it(monkeypatch):
    ...
    annotate = basstler.integration_selection.branches_annotated_with_their_own_checks
    monkeypatch.setattr(
