...
import bastler.command_line
import bastler.dataclass_exception
import bastler.exceptions
import bastler.git_commands
import bastler.plan_model
from bastler.command_line import Command, commands_of
from bastler.dataclass_exception import DataclassException
from bastler.exceptions import ExternalCallFailed, GitCommandFailed
...
SHARED_MODULES = (
    bastler.command_line,
    bastler.dataclass_exception,
    bastler.exceptions,
    bastler.git_commands,
    bastler.plan_model,
)
"""
