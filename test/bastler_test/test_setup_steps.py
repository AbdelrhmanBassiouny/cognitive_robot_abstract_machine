...
import bastler.setup_steps
from bastler.build_dashboard import PullRequestLabel
from bastler.setup_steps import (
    COMMENT_MARKER,
    ForkLabels,
    git_value,
    PersistentVariables,
...
SETUP_STEPS_MODULE = bastler.setup_steps.__name__
...
def test_the_module_writes_the_scheme_once() -> None:
    ...
    """
    source = Path(bastler.setup_steps.__file__).read_text(encoding="utf-8")
