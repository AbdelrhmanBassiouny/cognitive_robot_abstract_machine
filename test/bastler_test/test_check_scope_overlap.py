...
import bastler.check_scope_overlap
from bastler.check_scope_overlap import (
    Candidate,
    ReportKey,
    UnknownBranchError,
    build_scope_report,
...
"""
The module the command-line tests run, read off the import rather than retyped - a
module run by its file path would put the package's own directory on ``sys.path`` in
