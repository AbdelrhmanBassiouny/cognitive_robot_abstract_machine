...
from bastler.pages_site import (
    SITE_ROOT_PATH,
    PagesBuildType,
    PagesField,
    PagesSite,
...
from bastler.pull_request_state import HttpMethod, RepositoryEndpoints
from bastler.publish_site import DEFAULT_SITE_BRANCH
...
class RecordingApi:
    ...
    requests: list[tuple[HttpMethod, str, dict[str, Any] | None]] = field(
...
def test_a_site_github_reports_no_url_for_is_an_error(site):
    ...
    assert raised.value.branch == SITE_BRANCH
