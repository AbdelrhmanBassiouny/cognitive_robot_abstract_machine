...
from bastler.integration_block_record import BlockRecord, BlockRecords, MeasuredHead
from bastler.integration_failure import FailureLocationReport, IntegrationTestFailure
...
def locate_break(
...
) -> bastler.integration.BreakLocationReport:
    """
    ...
    """
    return bastler.integration_failure.FailureLocation(
