...
import bastler.integration_reproduction
...
import bastler.integration_commands
from bastler.integration_candidate_commands import ClearFixedBreaksCommand
from bastler.integration_constants import ReportKey
from bastler.stack import DefaultLabel, LabelWrite
...
PLUGIN_MODULE = bastler.integration_reproduction.__name__
"""
...
REQUIREMENTS_INSTALL = "${BASTLER_PACKAGE_DIRECTORY}"
"""
...
def test_the_command_is_reachable_by_the_name_the_targeted_job_invokes_it_by():
    ...
    assert CLEAR_FIXED_BREAKS_COMMAND.invoked_as in {
        command.invoked_as for command in bastler.integration_commands.COMMANDS
    }
