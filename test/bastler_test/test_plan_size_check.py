...
import bastler.plan_size_check
from bastler.plan_size_budget import PlanSize, SizeBudget
from bastler.plan_size_check import PlanSizeCheckResult, main

SCRIPT_NAME = Path(bastler.plan_size_check.__file__).name
"""
