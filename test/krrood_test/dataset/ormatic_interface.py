...
companywithemployeesdao_employees_association = Table(
    ...
    Base.metadata,
    Column(
        "source_companywithemployeesdao_id",
        ForeignKey("CompanyWithEmployeesDAO.database_id"),
    ),
    Column("target_personontodao_id", ForeignKey("PersonOntoDAO.database_id")),
)
...
peoplewithhoppydao_likes_association = Table(
    ...
    Base.metadata,
    Column(
        "source_peoplewithhoppydao_id", ForeignKey("PeopleWithHoppyDAO.database_id")
    ),
...
class CEODAO(
    SymbolDAO,
    DataAccessObject[test.krrood_test.dataset.university_ontology_like_classes.CEO],
):
    ...
    person_id: Mapped[int] = mapped_column(
        ForeignKey("PersonOntoDAO.database_id", use_alter=True),
        nullable=True,
        use_existing_column=True,
    )
    head_of_id: Mapped[int] = mapped_column(
        ForeignKey("CompanyDAO.database_id", use_alter=True),
        nullable=True,
        use_existing_column=True,
    )

    person: Mapped[PersonOntoDAO] = relationship(
        "PersonOntoDAO", uselist=False, foreign_keys=[person_id], post_update=True
    )
    head_of: Mapped[CompanyDAO] = relationship(
        "CompanyDAO", uselist=False, foreign_keys=[head_of_id], post_update=True
    )
...
class CompanyDAO(
    SymbolDAO,
    DataAccessObject[test.krrood_test.dataset.university_ontology_like_classes.Company],
):
    ...
    members: Mapped[builtins.set[PersonOntoDAO]] = relationship(
        "PersonOntoDAO",
        secondary="companydao_members_association",
        primaryjoin="CompanyDAO.database_id == companydao_members_association.c.source_companydao_id",
        secondaryjoin="PersonOntoDAO.database_id == companydao_members_association.c.target_personontodao_id",
        cascade="save-update, merge",
    )
...
class CompanyWithEmployeesDAO(
    SymbolDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.CompanyWithEmployees
    ],
):
    ...
    company: Mapped[CompanyDAO] = relationship(
        "CompanyDAO", uselist=False, foreign_keys=[company_id], post_update=True
    )
    employees: Mapped[builtins.list[PersonOntoDAO]] = relationship(
        "PersonOntoDAO",
        secondary="companywithemployeesdao_employees_association",
        primaryjoin="CompanyWithEmployeesDAO.database_id == companywithemployeesdao_employees_association.c.source_companywithemployeesdao_id",
        secondaryjoin="PersonOntoDAO.database_id == companywithemployeesdao_employees_association.c.target_personontodao_id",
        cascade="save-update, merge",
    )
...
class EmployeeDAO(
    SymbolDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.Employee
    ],
):
    ...
    works_for: Mapped[builtins.list[CompanyDAO]] = relationship(
        "CompanyDAO",
        ...
        secondaryjoin="CompanyDAO.database_id == employeedao_works_for_association.c.target_companydao_id",
        cascade="save-update, merge",
    )
...
class ExperiencedCEODAO(
    SymbolDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.ExperiencedCEO
    ],
):
    ...
    ceo_id: Mapped[int] = mapped_column(
        ForeignKey("CEODAO.database_id", use_alter=True),
        nullable=True,
        use_existing_column=True,
    )

    ceo: Mapped[CEODAO] = relationship(
        "CEODAO", uselist=False, foreign_keys=[ceo_id], post_update=True
    )
    experiences: Mapped[builtins.list[CompanyDAO]] = relationship(
        "CompanyDAO",
        secondary="experiencedceodao_experiences_association",
        primaryjoin="ExperiencedCEODAO.database_id == experiencedceodao_experiences_association.c.source_experiencedceodao_id",
        secondaryjoin="CompanyDAO.database_id == experiencedceodao_experiences_association.c.target_companydao_id",
        cascade="save-update, merge",
    )
...
class InterestDAO(
    SymbolDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.Interest
    ],
):
...
class GamingDAO(
    InterestDAO,
    DataAccessObject[test.krrood_test.dataset.university_ontology_like_classes.Gaming],
):
...
class SportsDAO(
    InterestDAO,
    DataAccessObject[test.krrood_test.dataset.university_ontology_like_classes.Sports],
):
...
class BasketBallDAO(
    SportsDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.BasketBall
    ],
):
...
class PeopleWithHoppyDAO(
    SymbolDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.PeopleWithHoppy
    ],
):
    ...
    likes: Mapped[builtins.list[SymbolDAO]] = relationship(
        "SymbolDAO",
        secondary="peoplewithhoppydao_likes_association",
        primaryjoin="PeopleWithHoppyDAO.database_id == peoplewithhoppydao_likes_association.c.source_peoplewithhoppydao_id",
        secondaryjoin="SymbolDAO.database_id == peoplewithhoppydao_likes_association.c.target_symboldao_id",
        cascade="save-update, merge",
    )
...
class GamerDAO(
    PeopleWithHoppyDAO,
    DataAccessObject[test.krrood_test.dataset.university_ontology_like_classes.Gamer],
):

    __tablename__ = "GamerDAO"

    database_id: Mapped[builtins.int] = mapped_column(
        ForeignKey(PeopleWithHoppyDAO.database_id),
        primary_key=True,
        use_existing_column=True,
    )
...
class SportsLoverDAO(
    PeopleWithHoppyDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.SportsLover
    ],
):
    ...
    loves: Mapped[builtins.list[SportsDAO]] = relationship(
        "SportsDAO",
...
class BasketBallLoverDAO(
    SportsLoverDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.BasketBallLover
    ],
):
...
class PersonOntoDAO(
    SymbolDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.PersonOnto
    ],
):
    ...
    works_for: Mapped[builtins.set[CompanyDAO]] = relationship(
        "CompanyDAO",
        secondary="personontodao_works_for_association",
        primaryjoin="PersonOntoDAO.database_id == personontodao_works_for_association.c.source_personontodao_id",
        secondaryjoin="CompanyDAO.database_id == personontodao_works_for_association.c.target_companydao_id",
        cascade="save-update, merge",
    )
    member_of: Mapped[builtins.set[CompanyDAO]] = relationship(
        "CompanyDAO",
        secondary="personontodao_member_of_association",
        primaryjoin="PersonOntoDAO.database_id == personontodao_member_of_association.c.source_personontodao_id",
        secondaryjoin="CompanyDAO.database_id == personontodao_member_of_association.c.target_companydao_id",
        cascade="save-update, merge",
    )
...
class HasAttributeDAO(
    PredicateDAO, DataAccessObject[krrood.entity_query_language.predicate.HasAttribute]
):
...
class IsSubClassOfDAO(
    ...
    child_cls: Mapped[TypeType] = mapped_column(
        TypeType, nullable=False, use_existing_column=True
    )
    parent_cls: Mapped[TypeType] = mapped_column(
        TypeType, nullable=False, use_existing_column=True
    )
...
class IsSubClassOrRoleDAO(
    PredicateDAO,
    DataAccessObject[krrood.entity_query_language.predicate.IsSubClassOrRole],
):
...
class RepresentativeDAO(
    SymbolDAO,
    DataAccessObject[
        test.krrood_test.dataset.university_ontology_like_classes.Representative
    ],
):
    ...
    representative_of: Mapped[CompanyDAO] = relationship(
        "CompanyDAO",
        uselist=False,
