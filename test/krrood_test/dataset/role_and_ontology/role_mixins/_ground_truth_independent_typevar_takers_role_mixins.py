...
if TYPE_CHECKING:
    from test.krrood_test.dataset.role_and_ontology.independent_typevar_takers import ContentHolder, NarrowedRootHolder, RootHolder, TContent, TContent2, TMultiTaker, TRoot, TSpecificRoot
...
@dataclass(eq=False)
class RoleForRootHolder(DelegatorForRootHolder, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> RootHolder:
        ...
...
@dataclass(eq=False)
class RoleForNarrowedRootHolder(DelegatorForNarrowedRootHolder, RoleForRootHolder, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> NarrowedRootHolder:
        ...
...
@dataclass(eq=False)
class RoleForContentHolder(DelegatorForContentHolder, RoleForNarrowedRootHolder, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> ContentHolder:
        ...
...
@dataclass(eq=False)
class RoleForMultiTaker(DelegatorForMultiTaker, RoleForContentHolder, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> TMultiTaker:
        ...
