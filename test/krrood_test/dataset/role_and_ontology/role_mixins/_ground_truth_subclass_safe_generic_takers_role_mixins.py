...
if TYPE_CHECKING:
    from test.krrood_test.dataset.role_and_ontology.subclass_safe_generic_takers import ItemHolder, SpecificItemTaker, TItem, TSpecificItem
...
@dataclass(eq=False)
class RoleForItemHolder(DelegatorForItemHolder, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> ItemHolder:
        ...
...
@dataclass(eq=False)
class RoleForSpecificItemTaker(DelegatorForSpecificItemTaker, RoleForItemHolder, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> SpecificItemTaker:
        ...
