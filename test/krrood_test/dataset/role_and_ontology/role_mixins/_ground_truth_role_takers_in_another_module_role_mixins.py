...
if TYPE_CHECKING:
    ...
    from test.krrood_test.dataset.role_and_ontology.university_ontology_like_classes_without_descriptors import PersonInRoleAndOntology
...
class DelegatorForRoleTakerInAnotherModule(ABC):
    ...
    def attribute_with_annotation_from_role_module(self, value: PersonInRoleAndOntology):
        self.delegatee.attribute_with_annotation_from_role_module = value


@dataclass(eq=False)
class RoleForRoleTakerInAnotherModule(DelegatorForRoleTakerInAnotherModule, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> RoleTakerInAnotherModule:
        ...
