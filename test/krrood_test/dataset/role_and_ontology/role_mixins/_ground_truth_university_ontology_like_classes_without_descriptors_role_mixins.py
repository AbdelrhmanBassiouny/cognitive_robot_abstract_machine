...
if TYPE_CHECKING:
    from test.krrood_test.dataset.role_and_ontology.university_ontology_like_classes_without_descriptors import HasName, RecognizedGroup, TCEOAsFirstRole, TPersonInRoleAndOntology, TRepresentativeAsSecondRole, TSubclassOfARoleTaker
...
@dataclass(eq=False)
class RoleForHasName(DelegatorForHasName, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> HasName:
        ...
...
@dataclass(eq=False)
class RoleForPersonInRoleAndOntology(DelegatorForPersonInRoleAndOntology, RoleForHasName, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> TPersonInRoleAndOntology:
        ...
...
@dataclass(eq=False)
class RoleForSubclassOfARoleTaker(DelegatorForSubclassOfARoleTaker, RoleForPersonInRoleAndOntology, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> TSubclassOfARoleTaker:
        ...
...
@dataclass(eq=False)
class RoleForCEOAsFirstRole(DelegatorForCEOAsFirstRole, RoleForPersonInRoleAndOntology, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> TCEOAsFirstRole:
        ...
...
@dataclass(eq=False)
class RoleForRepresentativeAsSecondRole(DelegatorForRepresentativeAsSecondRole, RoleForCEOAsFirstRole, ABC):
    @property
    @abstractmethod
    def delegatee(self) -> TRepresentativeAsSecondRole:
        ...
