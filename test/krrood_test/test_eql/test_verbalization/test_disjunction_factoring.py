...
A factored disjunction is one clause, so it carries no *"either"* header — unlike a
general disjunction, whose disjuncts are separate points (see
:mod:`...test_disjunction_nesting`).
"""
...
def test_disjuncts_on_different_subjects_are_not_factored():
    ...
    assert (
        ...
        == "either the battery of a Robot is greater than 50, "
