...
Exercises this through the full engine (:class:`RDRBackend`, :class:`EQLSingleClassRDR`);
see ``test_underspecified_match.py`` for the self-contained unit tests of the underlying
``UnderspecifiedMatch`` adapter.
"""
