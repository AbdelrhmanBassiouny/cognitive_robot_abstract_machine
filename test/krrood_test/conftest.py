...
from .dataset import example_classes, semantic_world_like_classes, university_ontology_like_classes
...
def generate_sqlalchemy_interface():
    ...
    all_classes |= set(classes_of_module(university_ontology_like_classes))
    all_classes |= {Symbol}
    ...
    all_classes = {
        ...
        and not issubclass(c, PropertyDescriptor)
    }
