...
class BenchObject(NamedEntity):
    ...
    def __eq__(self, other: object) -> bool:
        """
        Compare recorded properties and numeric position coordinates.

        :param other: Object to compare with this scene object.
        """
    ...
    def __hash__(self) -> int:
        """Hash the recorded properties and position coordinates."""
