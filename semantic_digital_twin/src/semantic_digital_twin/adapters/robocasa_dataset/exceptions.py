...
class RoboCasaApplianceNotFoundError(DataclassException, LookupError):
    """
    Raised when no configured RoboCasa fixture matching a requested appliance
    category can be found in any kitchen layout.
    """
...
class RoboCasaTaskNotFoundError(DataclassException, LookupError):
    """
    Raised when a requested task name does not correspond to a registered
    RoboCasa kitchen task environment.
    """
...
class RoboCasaObjectAssetsNotFoundError(DataclassException, FileNotFoundError):
    """
    Raised when no downloaded asset files can be found for a requested RoboCasa
    object category.
    """
...
class RoboCasaObjectInstanceIndexError(DataclassException, IndexError):
    """
    Raised when a requested object instance index exceeds the number of
    downloaded instances of a RoboCasa object category.
    """
...
class RoboCasaObjectHasNoCollisionError(DataclassException, ValueError):
    """
    Raised when a loaded RoboCasa object world contains no body with collision
