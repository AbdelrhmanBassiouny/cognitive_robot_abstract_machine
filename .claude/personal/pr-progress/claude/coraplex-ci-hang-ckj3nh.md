...
**Verified in CI**
- `test_each_lib (coraplex) / test`: success in 24 min (0bc4e75b3) and 23m34s
  (e934e86c1), against the 6 h cancellation.
...
Confirmed again on the rebased head e934e86c1: `test_each_lib (coraplex) / test` success in
23m34s. Nothing outstanding.
