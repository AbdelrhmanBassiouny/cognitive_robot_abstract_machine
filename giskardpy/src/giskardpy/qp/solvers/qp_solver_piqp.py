...
class QPSolverPIQP(QPSolver[QPDataExplicit]):
    ...
    Each pass brings the problem closer to fully balanced, which piqp reaches at its
    default of ten. Measured over the problems of the test suites, a few of them then
    end at the iteration limit with the solution already optimal, while at five passes
    all of them solve.
    """
    ...
    def __post_init__(self):
        ...
        self.solver.settings.preconditioner_iter = self.equilibrium_passes
