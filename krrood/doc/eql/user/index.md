...
11. **[Verbalization](verbalization.md)**: Turn any EQL expression into a human-readable English sentence — useful for debugging, explainability, and testing.
12. **[Why-Questions](why_questions.md)**: Ask a Ripple-Down-Rules reasoner *why* it reached a conclusion and read the answer back as a plain causal explanation.
