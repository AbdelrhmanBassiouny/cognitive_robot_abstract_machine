...
A small museum collection scenario: each ``Exhibit`` has observable features (material,
size, has_inscription) and must be classified into an ``ExhibitKind`` (Pottery / Jewelry
/ Tablet).  Nothing is imported from test/ — this module is the single source of truth
for the running example used in both docs.
"""
