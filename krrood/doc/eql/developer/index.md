...
8.  **[RDR Architecture Plan](rdr_architecture_plan.md)**: The forward-looking design brief for the EQL-based RDR package: feature sharing, concept trees, and OO integration.