...
class Operand:
    ...
    :class:`VerbalizationFragment` in the current context. It is used DIRECTLY (``Noun(operands.body)``);
    a fragment may not navigate into it — a verbalization is built only from the operands the operation
    declares.
