...
def underspecified(
    ...
    :param domain: Optional instances to range over. When given, a backend (e.g. the RDR
        backend) can iterate the domain and infer the underspecified (``...``) attributes
        on each instance, rather than generating solutions from scratch.
