...
class AgreementProcessor(RealizationPass):
    ...
    *"all elements are close"*. The number DECISION stays upstream (the subject noun's number is set
    ...
    @staticmethod
    def _subject_number(clause: Clause) -> Optional[GrammaticalNumber]:
